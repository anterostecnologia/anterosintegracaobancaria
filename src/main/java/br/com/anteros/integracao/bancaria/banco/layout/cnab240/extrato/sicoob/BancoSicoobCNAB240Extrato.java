...
@FlatFile(name = "Arquivo CNAB240 - Banco Sicoob", description = "Arquivo de retorno CONCILIAÇÃO BANCÁRIA CNAB240", version = "1.0")
public class BancoSicoobCNAB240Extrato implements CNAB240Extrato {
	...
	@Record(name = HEADER_CONCILIACAO_BANCARIA, description = "Cabeçalho conciliação bancária", order = 2, groups = { RETORNO_CONCILIACAO_BANCARIA })
	protected HeaderConciliacaoBancaria headerConciliacaoBancaria;

	@Record(name = CONCILIACAO_BANCARIA_SEGMENTO_E, description = "Segmento E Conciliação bancária", order = 3, repeatable = true, groups = { RETORNO_CONCILIACAO_BANCARIA })
	protected ConciliacaoBancariaSegmentoE segmentoE;

	@Record(name = TRAILLER_CONCILIACAO_BANCARIA, description = "Resumo lote de cobrança", order = 4, groups = { RETORNO_CONCILIACAO_BANCARIA })
	protected TraillerConciliacaoBancaria traillerConciliacaoBancaria;
	
	@Record(name = TRAILLER, order = 5, groups = { RETORNO_CONCILIACAO_BANCARIA })
	protected TraillerArquivo traillerArquivo;

	private ContaBancaria contaBancaria;

	protected BancoSicoobCNAB240Extrato(ContaBancaria contaBancaria, Date dataHoraGeracao) {
	...
	public static CNAB240Extrato of(ContaBancaria contaBancaria, Date dataHoraGeracao) {
		return new BancoSicoobCNAB240Extrato(contaBancaria, dataHoraGeracao);
	}
