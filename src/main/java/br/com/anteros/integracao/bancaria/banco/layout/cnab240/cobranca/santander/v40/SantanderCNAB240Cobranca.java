...
@FlatFile(name = "Arquivo CNAB240 - Santander", description = "Arquivo de remessa/retorno COBRANÇA CNAB240", version = "1.0")
public class SantanderCNAB240Cobranca implements CNAB240Cobranca {
	...
	protected SantanderCNAB240Cobranca(ContaBancaria contaBancaria, List<RemessaCobranca> remessas, Date dataHoraGeracao,
			Date dataGravacao) {
	...
	protected SantanderCNAB240Cobranca(ContaBancaria contaBancaria, Date dataHoraGeracao, Date dataGravacao) {
		this.contaBancaria = contaBancaria;
	...
	public static SantanderCNAB240Cobranca of(ContaBancaria contaBancaria, List<RemessaCobranca> remessas,
			Date dataHoraGeracao, Date dataGravacao) {
		return new SantanderCNAB240Cobranca(contaBancaria, remessas, dataHoraGeracao, dataGravacao);
	}

	public static SantanderCNAB240Cobranca of(ContaBancaria contaBancaria, Date dataHoraGeracao, Date dataGravacao) {
		return new SantanderCNAB240Cobranca(contaBancaria, dataHoraGeracao, dataGravacao);
	}

	public static SantanderCNAB240Cobranca of(ContaBancaria contaBancaria, List<RemessaCobranca> remessas) {
		return new SantanderCNAB240Cobranca(contaBancaria, remessas, Calendar.getInstance().getTime(),
				Calendar.getInstance().getTime());
	}

	public static SantanderCNAB240Cobranca of(ContaBancaria contaBancaria) {
		return new SantanderCNAB240Cobranca(contaBancaria, Calendar.getInstance().getTime(),
				Calendar.getInstance().getTime());
	}
