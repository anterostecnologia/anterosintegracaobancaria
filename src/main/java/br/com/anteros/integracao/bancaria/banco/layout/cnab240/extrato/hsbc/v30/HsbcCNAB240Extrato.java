...
@FlatFile(name = "Arquivo CNAB240 - HSBC", description = "Arquivo de retorno CONCILIAÇÃO BANCÁRIA CNAB240", version = "1.0")
public class HsbcCNAB240Extrato implements CNAB240Extrato {
	...
	protected HsbcCNAB240Extrato(ContaBancaria contaBancaria, Date dataHoraGeracao) {
	...
	public static CNAB240Extrato of(ContaBancaria contaBancaria, Date dataHoraGeracao) {
		return new HsbcCNAB240Extrato(contaBancaria, dataHoraGeracao);
	}
