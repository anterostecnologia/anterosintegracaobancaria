...
public class BancoBrasilCNAB240Cobranca implements CNAB240Cobranca {
	...
	protected BancoBrasilCNAB240Cobranca(ContaBancaria contaBancaria, Date dataHoraGeracao, Date dataGravacao) {
		this.contaBancaria = contaBancaria;
	...
	public static BancoBrasilCNAB240Cobranca of(ContaBancaria contaBancaria, List<RemessaCobranca> remessas,
			Date dataHoraGeracao, Date dataGravacao) {
		return new BancoBrasilCNAB240Cobranca(contaBancaria, remessas, dataHoraGeracao, dataGravacao);
	}

	public static BancoBrasilCNAB240Cobranca of(ContaBancaria contaBancaria, Date dataHoraGeracao, Date dataGravacao) {
		return new BancoBrasilCNAB240Cobranca(contaBancaria, dataHoraGeracao, dataGravacao);
	}

	public static BancoBrasilCNAB240Cobranca of(ContaBancaria contaBancaria, List<RemessaCobranca> remessas) {
		return new BancoBrasilCNAB240Cobranca(contaBancaria, remessas, Calendar.getInstance().getTime(),
				Calendar.getInstance().getTime());
	}

	public static BancoBrasilCNAB240Cobranca of(ContaBancaria contaBancaria) {
		return new BancoBrasilCNAB240Cobranca(contaBancaria, Calendar.getInstance().getTime(),
				Calendar.getInstance().getTime());
	}
