...
import br.com.anteros.automacao.bancaria.campolivre.CampoLivre;
import br.com.anteros.automacao.bancaria.campolivre.CampoLivreFactory;
import br.com.anteros.automacao.bancaria.campolivre.NotSupportedBancoException;
import br.com.anteros.automacao.bancaria.campolivre.NotSupportedCampoLivreException;
...
public class Boleto {
	...
	private static Logger log = LoggerProvider.getInstance().getLogger(Boleto.class);
	...
	public Boleto(Titulo titulo)throws IllegalArgumentException, NotSupportedBancoException, NotSupportedCampoLivreException{
		...
		if(ObjectUtils.isNotEmpty(titulo)){
		...
		if(log.isDebugEnabled()){
			log.debug("Boleto Instanciado : "+this);
		}
	...
	private void load(){
		...
		if(log.isInfoEnabled()){			
			log.info("Data de Processamento do Boleto : "+DateUtil.toStringDateDMA(dataDeProcessamento));
		}
	}
	
	/**
	 * @return O campoLivre da instância.
	 */
	...
	public void addTextosExtras(String campo, String conteudo) {
		...
		if(ObjectUtils.isNull(getTextosExtras())) {
	...
	public void addImagensExtras(String campo, Image conteudo) {
		...
		if(ObjectUtils.isNull(getImagensExtras())) {
