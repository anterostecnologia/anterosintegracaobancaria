...
@FlatFile(name = "Arquivo CNAB240 - Caixa Econômica Federal", description = "Arquivo de remessa/retorno COBRANÇA CNAB240", version = "1.0")
public class CaixaEconomicaFederalCNAB240Cobranca implements CNAB240Cobranca {

	private static final int VERSAO_LAYOUT_ARQUIVO_BRADESCO = 20;
	private static final int VERSAO_LAYOUT_LOTE_BRADESCO = 30;
	...
	protected CaixaEconomicaFederalCNAB240Cobranca(ContaBancaria contaBancaria, List<RemessaCobranca> remessas, Date dataHoraGeracao,
			Date dataGravacao) {
	...
	protected CaixaEconomicaFederalCNAB240Cobranca(ContaBancaria contaBancaria, Date dataHoraGeracao, Date dataGravacao) {
		this.contaBancaria = contaBancaria;
	...
	public static CaixaEconomicaFederalCNAB240Cobranca of(ContaBancaria contaBancaria, List<RemessaCobranca> remessas,
			Date dataHoraGeracao, Date dataGravacao) {
		return new CaixaEconomicaFederalCNAB240Cobranca(contaBancaria, remessas, dataHoraGeracao, dataGravacao);
	}

	public static CaixaEconomicaFederalCNAB240Cobranca of(ContaBancaria contaBancaria, Date dataHoraGeracao, Date dataGravacao) {
		return new CaixaEconomicaFederalCNAB240Cobranca(contaBancaria, dataHoraGeracao, dataGravacao);
	}

	public static CaixaEconomicaFederalCNAB240Cobranca of(ContaBancaria contaBancaria, List<RemessaCobranca> remessas) {
		return new CaixaEconomicaFederalCNAB240Cobranca(contaBancaria, remessas, Calendar.getInstance().getTime(),
				Calendar.getInstance().getTime());
	}

	public static CaixaEconomicaFederalCNAB240Cobranca of(ContaBancaria contaBancaria) {
		return new CaixaEconomicaFederalCNAB240Cobranca(contaBancaria, Calendar.getInstance().getTime(),
				Calendar.getInstance().getTime());
	}
