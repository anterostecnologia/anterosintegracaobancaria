...
public class CobrancaSegmentoP implements RecordData {
	...
	@Field(name = "USO_RESERVADO_BANCO", length = 11, type = EnumTypes.LONG, padding = Paddings.ZERO_LEFT, value = "00000000000")
	private Long usoReservadoBanco;

	@Field(name = "MODALIDADE_CARTEIRA", length = 2, padding = Paddings.WHITE_SPACE_RIGHT)
	private String modalidadeCarteira;

	@Field(name = "IDENTIFICADOR_TITULO", length = 15, padding = Paddings.WHITE_SPACE_RIGHT)
	...
	@Field(name = "NR_DOCUMENTOCOBRANCA", length = 11, padding = Paddings.WHITE_SPACE_RIGHT)
	private String numeroDocumentoCobranca;

	@Field(name = "BRANCOS2", value = " ", padding = Paddings.WHITE_SPACE_RIGHT, length = 4)
	...
	public void readRowData(int row, int sequence) {
		...
		this.identificadorEmissaoBoleto = remessas.get(row).getTitulo().getCarteira().getTipoDeEmissaoBoleto()
				.getTipo();// C009
		this.identificacaoDistribuicao = remessas.get(row).getTitulo().getCarteira().getTipoDeDistribuicaoBoleto()
				.getTipo();// C010
	...
	public Long getUsoReservadoBanco() {
		return usoReservadoBanco;
	}

	public void setUsoReservadoBanco(Long usoReservadoBanco) {
