...
@FlatFile(name = "Arquivo CNAB240 - Itaú", description = "Arquivo de retorno CONCILIAÇÃO BANCÁRIA CNAB240", version = "1.0")
public class ItauCNAB240Extrato implements CNAB240Extrato {
	...
	protected ItauCNAB240Extrato(ContaBancaria contaBancaria, Date dataHoraGeracao) {
	...
	public static CNAB240Extrato of(ContaBancaria contaBancaria, Date dataHoraGeracao) {
		return new ItauCNAB240Extrato(contaBancaria, dataHoraGeracao);
	}
