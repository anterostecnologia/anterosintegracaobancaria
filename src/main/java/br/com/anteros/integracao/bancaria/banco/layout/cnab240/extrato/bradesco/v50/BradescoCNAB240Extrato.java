...
@FlatFile(name = "Arquivo CNAB240 - Bradesco", description = "Arquivo de retorno CONCILIAÇÃO BANCÁRIA CNAB240", version = "1.0")
public class BradescoCNAB240Extrato implements CNAB240Extrato {
	...
	protected BradescoCNAB240Extrato(ContaBancaria contaBancaria, Date dataHoraGeracao) {
	...
	public static CNAB240Extrato of(ContaBancaria contaBancaria, Date dataHoraGeracao) {
		return new BradescoCNAB240Extrato(contaBancaria, dataHoraGeracao);
	}
