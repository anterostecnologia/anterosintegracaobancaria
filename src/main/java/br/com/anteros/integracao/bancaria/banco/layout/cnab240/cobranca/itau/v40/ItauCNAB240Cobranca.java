...
@FlatFile(name = "Arquivo CNAB240 - Itaú", description = "Arquivo de remessa/retorno COBRANÇA CNAB240", version = "1.0")
public class ItauCNAB240Cobranca implements CNAB240Cobranca {
	...
	protected ItauCNAB240Cobranca(ContaBancaria contaBancaria, List<RemessaCobranca> remessas, Date dataHoraGeracao,
			Date dataGravacao) {
	...
	protected ItauCNAB240Cobranca(ContaBancaria contaBancaria, Date dataHoraGeracao, Date dataGravacao) {
		this.contaBancaria = contaBancaria;
	...
	public static ItauCNAB240Cobranca of(ContaBancaria contaBancaria, List<RemessaCobranca> remessas,
			Date dataHoraGeracao, Date dataGravacao) {
		return new ItauCNAB240Cobranca(contaBancaria, remessas, dataHoraGeracao, dataGravacao);
	}

	public static ItauCNAB240Cobranca of(ContaBancaria contaBancaria, Date dataHoraGeracao, Date dataGravacao) {
		return new ItauCNAB240Cobranca(contaBancaria, dataHoraGeracao, dataGravacao);
	}

	public static ItauCNAB240Cobranca of(ContaBancaria contaBancaria, List<RemessaCobranca> remessas) {
		return new ItauCNAB240Cobranca(contaBancaria, remessas, Calendar.getInstance().getTime(),
				Calendar.getInstance().getTime());
	}

	public static ItauCNAB240Cobranca of(ContaBancaria contaBancaria) {
		return new ItauCNAB240Cobranca(contaBancaria, Calendar.getInstance().getTime(),
				Calendar.getInstance().getTime());
	}
