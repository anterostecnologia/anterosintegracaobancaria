...
public class CobrancaSegmentoP implements RecordData {
	...
	@Field(name = FORMA_CADASTRO_TITULO, length = 1, type = EnumTypes.INTEGER, padding = Paddings.ZERO_LEFT, value="0")
	private Integer formaCadastroTitulo;

	@Field(name = TP_DOCUMENTO, length = 1, padding = Paddings.WHITE_SPACE_RIGHT, value=" ")
	...
	@Field(name = AGENCIA_ENCARREGADA_COBRANCA, length = 5, type = EnumTypes.INTEGER, padding = Paddings.ZERO_LEFT, value="00000")
	private Integer agenciaEncarregadaCobranca;

	@Field(name = DIGITO_VERIFICADOR_AGENCIA_COBRANCA, length = 1, padding = Paddings.WHITE_SPACE_RIGHT, value=" ")
	...
	@Field(name = CD_BAIXADEVOLUCAO, length = 1, type = EnumTypes.INTEGER, padding = Paddings.ZERO_LEFT, value="0")
	private Integer codigoBaixaDevolucao;

	@Field(name = NR_DIAS_BAIXA_DEVOLUCAO, length = 3, value = " ", padding = Paddings.WHITE_SPACE_RIGHT)
