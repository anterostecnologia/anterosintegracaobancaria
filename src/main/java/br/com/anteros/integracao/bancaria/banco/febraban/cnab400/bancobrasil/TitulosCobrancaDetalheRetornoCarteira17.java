...
public class TitulosCobrancaDetalheRetornoCarteira17 implements RecordData, DetalheRetorno {
	...
	private static final String INDICATIVO_DEBITO_CREDITO = "INDICATIVO_DEBITO_CREDITO";
	private static final String INDICADOR_VALOR = "INDICADOR_VALOR";
	private static final String VL_LANCAMENTO = "VL_LANCAMENTO";
	...
	private static final String VL_JUROSDESCONTO = "VL_JUROSDESCONTO";
	private static final String VL_OUTRASDESPESAS = "VL_OUTRASDESPESAS";
	private static final String VL_DESPESAS_COBRANCA = "VL_DESPESAS_COBRANCA";
	...
	private static final String TAXA_IOF = "TAXA_IOF";
	private static final String TAXA_DESCONTO = "TAXA_DESCONTO";
	private static final String VARIACAO_CARTEIRA = "VARIACAO_CARTEIRA";
	private static final String TP_COBRANCA_ESPECIFICO = "TP_COBRANCA_ESPECIFICO";
	private static final String TP_COBRANCA = "TP_COBRANCA";
	private static final String NOSSO_NUMERO = "NOSSO_NUMERO";
	private static final String NR_CONVENIO = "NR_CONVENIO";
	private static final String CD_REGISTRO = "CD_REGISTRO";
	private static final String CD_BANCO_RECEBEDOR = "CD_BANCO_RECEBEDOR";
	private static final String VL_ABATIMENTO_NAO_APROVEITADO = "VL_ABATIMENTO_NAO_APROVEITADO";
	...
	@Field(name = ESPECIE_TITULO, length = 2)
	...
	public TitulosCobrancaDetalheRetornoCarteira17(ContaBancaria contaBancaria) {
	...
	public void setCodigoOcorrencia(Integer codigoOcorrencia) {
		this.codigoMovimentoRetorno = codigoOcorrencia;
	}
	...
	public static TitulosCobrancaDetalheRetornoCarteira17 of(ContaBancaria contaBancaria) {
		return new TitulosCobrancaDetalheRetornoCarteira17(contaBancaria);
	}
	...
	public void set(Record record) {
		...
		setCodigoOcorrencia((Integer) record.getValue(CD_MOVIMENTO_RETORNO));
		...
		setEspecieTitulo((String) record.getValue(ESPECIE_TITULO));
