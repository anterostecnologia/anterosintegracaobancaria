package br.com.anteros.integracao.bancaria.banco.layout.cnab400.cobranca.itau;
...
public class ItauCNAB400 implements CNAB400 {
	...
	public ItauCNAB400(ContaBancaria contaBancaria, List<RemessaCobranca> remessas, Date dataHoraGeracao,
			Date dataGravacao) {
	...
	public ItauCNAB400(ContaBancaria contaBancaria, Date dataHoraGeracao, Date dataGravacao) {
		headerArquivoRetorno = HeaderArquivoRetorno.of(contaBancaria);
		detalheRetorno = TitulosCobrancaDetalheRetorno.of(contaBancaria);
		traillerArquivoRetorno = TraillerArquivoRetorno.of(contaBancaria);
	}
