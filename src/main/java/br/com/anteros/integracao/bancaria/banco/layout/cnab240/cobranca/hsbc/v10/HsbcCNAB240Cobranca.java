...
@FlatFile(name = "Arquivo CNAB240 - HSBC", description = "Arquivo de remessa/retorno COBRANÇA CNAB240", version = "1.0")
public class HsbcCNAB240Cobranca implements CNAB240Cobranca {
	...
	protected HsbcCNAB240Cobranca(ContaBancaria contaBancaria, List<RemessaCobranca> remessas, Date dataHoraGeracao,
			Date dataGravacao) {
	...
	protected HsbcCNAB240Cobranca(ContaBancaria contaBancaria, Date dataHoraGeracao, Date dataGravacao) {
		this.contaBancaria = contaBancaria;
	...
	public static HsbcCNAB240Cobranca of(ContaBancaria contaBancaria, List<RemessaCobranca> remessas,
			Date dataHoraGeracao, Date dataGravacao) {
		return new HsbcCNAB240Cobranca(contaBancaria, remessas, dataHoraGeracao, dataGravacao);
	}

	public static HsbcCNAB240Cobranca of(ContaBancaria contaBancaria, Date dataHoraGeracao, Date dataGravacao) {
		return new HsbcCNAB240Cobranca(contaBancaria, dataHoraGeracao, dataGravacao);
	}

	public static HsbcCNAB240Cobranca of(ContaBancaria contaBancaria, List<RemessaCobranca> remessas) {
		return new HsbcCNAB240Cobranca(contaBancaria, remessas, Calendar.getInstance().getTime(),
				Calendar.getInstance().getTime());
	}

	public static HsbcCNAB240Cobranca of(ContaBancaria contaBancaria) {
		return new HsbcCNAB240Cobranca(contaBancaria, Calendar.getInstance().getTime(),
				Calendar.getInstance().getTime());
	}
