...
public class HeaderArquivo {		
	...
	@Field(name = "BRANCOS2", length = 30, value = " ", padding = Paddings.WHITE_SPACE_RIGHT)
	private String brancos2;
	
	@Field(name = CD_BANCO, length = 3, type = EnumTypes.INTEGER)
	private Integer codigoBanco;
	
	@Field(name = "BRANCOS3", length = 15, value = " ", padding = Paddings.WHITE_SPACE_RIGHT)
	private String brancos3;
	
	@Field(name = DT_GRAVACAO, length = 6, type = EnumTypes.DATE)
	private Date dataGravacao;
	
	@Field(name = "BRANCOS4", length = 5, value = " ", padding = Paddings.WHITE_SPACE_RIGHT)
	private String brancos4;
	
	@Field(name = "BRANCOS5", length = 3, value = " ", padding = Paddings.WHITE_SPACE_RIGHT)
	private String brancos5;
	
	@Field(name = "BRANCOS6", length = 56, value = " ", padding = Paddings.WHITE_SPACE_RIGHT)
	private String brancos6;
	
	@Field(name = "BRANCOS7", length = 8, value = " ", padding = Paddings.WHITE_SPACE_RIGHT)
	private String brancos7;
	
	@Field(name = "BRANCOS8", length = 14, value = " ", padding = Paddings.WHITE_SPACE_RIGHT)
	private String brancos8;
	
	@Field(name = "BRANCOS9", length = 3, value = " ", padding = Paddings.WHITE_SPACE_RIGHT)
	private String brancos9;
	
	@Field(name = "BRANCOS10", length = 2, value = " ", padding = Paddings.WHITE_SPACE_RIGHT)
	private String brancos10;
	
	@Field(name = "BRANCOS11", length = 3, value = " ", padding = Paddings.WHITE_SPACE_RIGHT)
