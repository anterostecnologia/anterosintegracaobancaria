...
public class BancoSicoobCNAB240RemessaCobranca implements CNAB240Cobranca {
	...
	@Record(name = COBRANCA_SEGMENTO_P, description = "Segmento P Remessa dos titulos cobrança", order = 3, repeatable = true, groups = {REMESSA_COBRANCA })
	protected CobrancaSegmentoP segmentoP;

	@InnerRecord(name = COBRANCA_SEGMENTO_Q, description = "Segmento Q Remessa dos titulos cobrança", recordOwner = COBRANCA_SEGMENTO_P, order = 4, repeatable = true, groups = {REMESSA_COBRANCA })
	protected CobrancaSegmentoQ segmentoQ;

	@InnerRecord(name = COBRANCA_SEGMENTO_R, description = "Segmento R Remessa dos titulos cobrança", recordOwner = COBRANCA_SEGMENTO_P, order = 5, repeatable = true, groups = {REMESSA_COBRANCA })
	protected CobrancaSegmentoR segmentoR;

	@InnerRecord(name = COBRANCA_SEGMENTO_S, description = "Segmento S Remessa dos titulos cobrança", recordOwner = COBRANCA_SEGMENTO_P, order = 6, repeatable = true, groups = {REMESSA_COBRANCA })
	protected CobrancaSegmentoS segmentoS;
	...
	protected BancoSicoobCNAB240RemessaCobranca(ContaBancaria contaBancaria, List<RemessaCobranca> remessas,
		...
		segmentoR = CobrancaSegmentoR.of(contaBancaria, remessas);
		segmentoS = CobrancaSegmentoS.of(contaBancaria, remessas);
		traillerCobranca = TraillerCobranca.of(contaBancaria, remessas);
		traillerArquivo = TraillerArquivo.of(contaBancaria);
	}

	protected BancoSicoobCNAB240RemessaCobranca(ContaBancaria contaBancaria, Date dataHoraGeracao, Date dataGravacao) {
		this.contaBancaria = contaBancaria;
	...
	public static BancoSicoobCNAB240RemessaCobranca of(ContaBancaria contaBancaria, List<RemessaCobranca> remessas,
			Date dataHoraGeracao, Date dataGravacao, Integer numeroSequencialArquivo) {
		return new BancoSicoobCNAB240RemessaCobranca(contaBancaria, remessas, dataHoraGeracao, dataGravacao, numeroSequencialArquivo);
	}

	public static BancoSicoobCNAB240RemessaCobranca of(ContaBancaria contaBancaria, Date dataHoraGeracao, Date dataGravacao) {
		return new BancoSicoobCNAB240RemessaCobranca(contaBancaria, dataHoraGeracao, dataGravacao);
	}

	public static BancoSicoobCNAB240RemessaCobranca of(ContaBancaria contaBancaria, List<RemessaCobranca> remessas, Integer numeroSequencialArquivo) {
		return new BancoSicoobCNAB240RemessaCobranca(contaBancaria, remessas, Calendar.getInstance().getTime(), Calendar.getInstance().getTime(), numeroSequencialArquivo);
	}

	public static BancoSicoobCNAB240RemessaCobranca of(ContaBancaria contaBancaria) {
		return new BancoSicoobCNAB240RemessaCobranca(contaBancaria, Calendar.getInstance().getTime(),
				Calendar.getInstance().getTime());
	}

	public int getVersaoLayoutArquivo() {
		return VERSAO_LAYOUT_ARQUIVO_SICOOB;
	}

	public int getVersaoLayoutLote() {
		return VERSAO_LAYOUT_LOTE_SICOOB;
	}
