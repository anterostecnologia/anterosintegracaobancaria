...
public class ItauCNAB240Test {
	...
	public void beforeExecuteTests() {
		remessas = CNAB240Helper.gerarTitulosParaRemessaCobranca(BancosSuportados.BANCO_ITAU.create());
	...
	public void deveGerarlSchemaXMLDoLayoutIgualAoModelo() throws IllegalArgumentException, IllegalAccessException,
		...
		File file = ResourceUtils.getFile("src/main/resources/layouts/Layout-CNAB240-BancoItau.xml");
		...
		Assert.assertEquals("Banco Itaú: Arquivo XML gerado diferente do modelo.", fileSchema, schema);
	}
	...
	public void deveGerarArquivoRemessaIgualAoModelo() throws IllegalArgumentException, IllegalAccessException,
		...
		File file = ResourceUtils.getFile("src/main/resources/arquivos-remessa/REM_CNAB240_BancoItau.REM");
		...
		Assert.assertEquals("Banco Itaú: Arquivo de REMESSA gerado diferente do modelo.", fileData, data);
	}
